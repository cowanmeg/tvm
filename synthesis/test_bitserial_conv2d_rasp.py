...
def verify_bitserial_conv2d_nhwc(batch, in_size, in_channel, num_filter, kernel, stride, padding,
    ...
    with tvm.target.create(device):
        ...
        B = topi.nn.bitserial_conv2d_nhwc(A, W, stride, padding, activation_bits, weight_bits,
                                          pack_dtype='uint8', out_dtype=out_dtype, unipolar=unipolar)
...
if __name__ == "__main__":
    ...
    test_bitserial_conv2d(56, 64, 64, 1, 1, 0)
    test_bitserial_conv2d(56, 64, 128, 3, 2, 0)
    test_bitserial_conv2d(56, 64, 128, 1, 2, 0)
    test_bitserial_conv2d(28, 128, 128, 3, 1, 1)
    test_bitserial_conv2d(28, 128, 256, 3, 2, 1)
    test_bitserial_conv2d(28, 128, 256, 1, 2, 0)
    test_bitserial_conv2d(14, 256, 256, 3, 1, 1)
    test_bitserial_conv2d(14, 256, 512, 3, 2, 1)
    test_bitserial_conv2d(14, 256, 512, 1, 2, 0)
    test_bitserial_conv2d(7, 512, 512, 3, 1, 1)
